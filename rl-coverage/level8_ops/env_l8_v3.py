"""env_l8_v3.py — L8 environment with extended observation space (32 dims).

Changes vs env_l8_dynamic.py:
  - 25 tracked modules (ibex_counter_P1 excluded: MHPMCounterNum=0)
  - n_episodes fraction in obs
  - action history: last 4 opcodes (intra-episode memory)
  - dynamic reward: weight = 1 / coverage_fraction (unchanged)

Obs layout (32 dims):
  [0]     step_idx / episode_steps
  [1]     cum_hits / total_toggles
  [2]     min(1, n_episodes / 500)
  [3..27] coverage fraction per module (25 modules)
  [28..31] last 4 chosen opcodes, normalised by N_OPS
"""
...
PROGRAM_JSON = "/tmp/rl_l8_v3.json"
...
HIST_LEN    = 4
N_OBS       = 3 + N_MODULES + HIST_LEN  # = 32 (ibex_counter_P1 excluded: MHPMCounterNum=0)
MAX_EP_NORM = 500.0
